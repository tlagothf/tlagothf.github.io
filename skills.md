...
- JSP 기반 동적 페이지와 폼 처리  
- JS를 이용한 입력값 검증, 버튼 이벤트 처리, 유효성 검사 구현:contentReference[oaicite:12]{index=12}  

## Tools & Collaboration

- IntelliJ, Eclipse, VS Code, RStudio  
- Git, SVN 기반 형상 관리 및 협업 경험  
- REST API 설계 및 Postman, Swagger 등을 활용한 테스트 경험 (필요 시 추가 기재)
